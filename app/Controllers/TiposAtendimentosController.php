<?php
// app/Controllers/TiposAtendimentosController.php
...
class TiposAtendimentosController 
{
    ...
    // 1. Operação: Listar todas as categorias
    ...
    // 2. Operação: Buscar categoria por ID
    ...
    // 3. Operação: Criar nova categoria (POST)
    ...
    // 4. Operação: Atualizar categoria (POST)
    ...
    // 5. Operação: Inativar categoria (POST) - RN11
